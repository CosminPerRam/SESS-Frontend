...
export const Command = () => {
  ...
  return <div className='command'>
      <Input type='search' value={inputCommand} handleInput={handleInputCommand} menu={"command"} className={"command-input"} onKeyDown={updateCommand} />
      <Button title={'Submit'} style={{marginLeft: '12px', marginRight: '7px'}} onClick={() => addLine()} />
    </div>
}
