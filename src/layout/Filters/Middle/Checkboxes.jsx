...
import {setCanBeEmpty, setCanBeFull, setCanHavePassword, setSpectatorProxy} from "../../../redux/filters/slice";
...
export const Checkboxes = () => {
    ...
    return <form className='checkboxes'>
            ...
            <Checkbox title={'Has users playing'} checked={!canBeEmpty} onChanged={() => dispatch(setCanBeEmpty(!canBeEmpty))}/>
            <Checkbox title={'Is not password protected'} checked={!canHavePassword} onChanged={() => dispatch(setCanHavePassword(!canHavePassword))}/>
            <Checkbox title={'Supports replays'} checked={spectatorProxy} onChanged={() => dispatch(setSpectatorProxy(!spectatorProxy))}/>
    </form>
}